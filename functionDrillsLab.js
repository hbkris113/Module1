...
*/
const jsNinja = () => {return 'I am a a JavaScript ninja!'};
console.log(jsNinja());
//CODE HERE
////////////////// PROBLEM 3 ////////////////////
/*
...
const theEliminator = (contestants, loser) => {
  ...
  if (contestants[i] === loser) {array.splice(i, 1); break;}} return contestants;}    
...
*/
function logUpperCaseString(inputString) {
