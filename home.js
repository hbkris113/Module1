...
const canWeDeliverArr = (zipCode) => { return deliveryAreaZipCodes.includes(zipCode) ?
     `You're in our delivery zone!` : `Sorry, we can't deliver to that address`};  
console.log(canWeDeliverArr(11111))   
//CODE HERE
...
*/
const firstDeal = deals[0].title.replace('15', '10')
...
*/
const secondDeal = deals[1].desc.replace('March', 'April').trim()
